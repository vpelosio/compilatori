; ModuleID = 'StrengthReductionTest.ll'
...
define dso_local void @testMulPowerOfTwoMinusOne() #0 {
  ...
  %11 = load i32, ptr %2, align 4
  %12 = mul nsw i32 %10, %11
  %13 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %5, i32 noundef %7, i32 noundef 135, i32 noundef %9, i32 noundef %12)
  ret void
}
...
define dso_local void @testMulPowerOfTwoPlusOne() #0 {
  ...
  %11 = load i32, ptr %2, align 4
  %12 = mul nsw i32 %10, %11
  %13 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %5, i32 noundef %7, i32 noundef 153, i32 noundef %9, i32 noundef %12)
  ret void
}
